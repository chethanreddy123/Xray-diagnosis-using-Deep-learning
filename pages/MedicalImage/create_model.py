...
chexnet_weights = "MedicalImage/chexnet_weights/brucechou1983_CheXNet_Keras_0.3.0_weights.h5"
...
def create_model():
  ...
  #hyperparameters
  input_size = (224,224)
  tokenizer = joblib.load('MedicalImage/tokenizer.pkl')
  max_pad = 29
  batch_size = 100
  ...
  model_filename = 'MedicalImage/Encoder_Decoder_global_attention.h5'
